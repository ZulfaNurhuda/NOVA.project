export function TermsPage() {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-nova-bg py-8 px-4">
                ...
                <div className="space-y-8 text-gray-700 dark:text-slate-300">
                    <section>
                        ...
                        <p>
                            ...
                            you, whether personally or on behalf of an entity ("you") and NOVA
                            Org ("Company," "we," "us," or "our"), concerning your access to and use
                            of the https://nova website as well as any other media form,
