...
export function Footer() {
    ...
    return (
        <footer className="mt-16 py-8 border-t border-gray-200 dark:border-nova-border">
            <div className="max-w-4xl mx-auto px-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    {/* Left - Norwegian flag and tagline */}
                    <div className="flex items-center space-x-3">
                        <Link to="/" className="flex items-center space-x-2 group">
                            <span className="text-gray-500 dark:text-slate-400 text-xs group-hover:text-nova-accent-dim dark:group-hover:text-nova-accent transition-colors">
                                {t('footer.tagline')}
                            </span>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-5 pl-5 border-l border-gray-300 dark:border-nova-border-2">
                            <a
